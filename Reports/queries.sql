...
SELECT 
    ...
    RUNNER_CANDIDATE,
    RUNNER_PARTY,
    MAX(CAND.RUNNER_VOTES) AS RUNNER_VOTES,
	(WINNER_VOTES - RUNNER_VOTES) AS DIFFERENCE_IN_VOTES
FROM
    (SELECT 
        GER.CANDIDATE AS RUNNER_CANDIDATE,
            GER.PARTY AS RUNNER_PARTY,
            GER.CONSTITUENCY AS RUNNER_CONSTITUENCY,
            GER.VOTES AS RUNNER_VOTES,
...
GROUP BY CAND.RUNNER_CONSTITUENCY
